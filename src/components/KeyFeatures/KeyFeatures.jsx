  ...
  const features = [
    {
      ...
      img: <FcFlowChart className=" h-20 w-20 bg-indigo-400 rounded-full p-3 -mt-16  shadow-md mb-8 " />,
      serviceDetails: "Custom web application development using MERN stack.",
    },
    {
      id: 2,
      serviceName: "Mobile App Development",
      img: <FcEngineering className=" h-20 w-20 bg-indigo-400 rounded-full p-3 -mt-16  shadow-md mb-8 " />,
      serviceDetails: "Native mobile app development for iOS and Android using React Native.",
    },
    {
      id: 3,
      serviceName: "Backend Development",
      img: <FcFilingCabinet className=" h-20 w-20 bg-indigo-400 rounded-full p-3 -mt-16  shadow-md mb-8 " />,
    ...
    },
    {
      ...
      img: <FcRotateToPortrait className=" h-20 w-20 bg-indigo-400 rounded-full p-3 -mt-16  shadow-md mb-8 " />,
      serviceDetails: "Building interactive user interfaces with React and Redux.",
    },
    {
      id: 5,
      serviceName: "Database Design",
      img: <FcDataConfiguration className=" h-20 w-20 bg-indigo-400 rounded-full p-3 -mt-16  shadow-md mb-8 " />,
      serviceDetails: "Designing efficient database schemas using MongoDB.",
    },
    {
      id: 6,
      serviceName: "UI/UX Design",
      img: <FcRatings className=" h-20 w-20 bg-indigo-400 rounded-full p-3 -mt-16  shadow-md mb-8 " />,
      serviceDetails: "Creating visually appealing and user-friendly interfaces.",
    },
    {
      id: 7,
      serviceName: "E-commerce Development",
      img: <FcComboChart className=" h-20 w-20 bg-indigo-400 rounded-full p-3 -mt-16  shadow-md mb-8 " />,
    ...
    },
    {
      ...
      img: <FcDoughnutChart className=" h-20 w-20 bg-indigo-400 rounded-full p-3 -mt-16  shadow-md mb-8 " />,
